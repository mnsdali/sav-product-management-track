...
@section('content')
    ...
    <div class="form-group prod-create-section">
        <form action="{{ route('variation.add') }}" method="post">
            @csrf
                    ...
                    <div class="card-body">
                        <div class="col-sm-12 col-md-6 col-lg-6 mx-auto">
                            ...
                            <div class="form-group multiselect_div">
                                {{-- ref-opt --}}
                                <select id="edit-piece-prod-select" name="referenceProd" class="multiselect multiselect-custom new-var-prods-select" required>
