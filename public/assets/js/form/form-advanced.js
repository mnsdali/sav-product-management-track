$(function() {
    ...
    // Multiselect
    $('#multiselect1, #multiselect2, #single-selection, .techniciens-list, #multiselect5, #multiselect6').multiselect();
    //Multi-select
    ...
    $('#edit-produit-select').multiselect({
        enableFiltering: true,
        enableCaseInsensitiveFiltering: true,
        maxHeight: 400
    });
    ...
    $('#edit-piece-prod-select').multiselect({
        enableFiltering: true,
        enableCaseInsensitiveFiltering: true,
        maxHeight: 400
    });

    $('#edit-piece-var-select').multiselect({
        enableFiltering: true,
        enableCaseInsensitiveFiltering: true,
        maxHeight: 400
    });

    $('#edit-piece-piece-select').multiselect({
        enableFiltering: true,
        enableCaseInsensitiveFiltering: true,
        maxHeight: 400
    });
