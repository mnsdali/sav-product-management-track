...
$(function() {
    ...
    $('.reclamations-data-table').DataTable();
    $('.variations-produit-data-table').DataTable();
    $('.data-table-articles-var').DataTable( {} );
    $('#pieces-dataTable').DataTable( {} );
    $('.revendeurDTable').DataTable( {} );
    $('.commandes-rev-data-table').DataTable( {} );
    $('.list-prod-dtable').DataTable( {} );
    $('.vars-data-table').DataTable( {} );
    //Exportable table
